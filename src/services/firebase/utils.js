export const errorTranslations = {
  ...
  "auth/email-already-in-use": "Otro usuario ya está utilizando el correo electrónico proporcionado. Cada usuario debe tener un correo electrónico único.",
...
export const getTranslation = (code) => {
  return errorTranslations[code] || errorTranslations['else'];
};
